...
[![GoDoc](https://godoc.org/github.com/litecoinfinance/btcwallet/walletdb?status.png)]
(http://godoc.org/github.com/litecoinfinance/btcwallet/walletdb)
...
http://localhost:6060/pkg/github.com/litecoinfinance/btcwallet/walletdb

## Installation

```bash
$ go get github.com/litecoinfinance/btcwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/litecoinfinance/btcwallet/walletdb#example-package--BasicUsage)  
